...
import DropdownTrigger from '#kit/components/fragments/dropdown/trigger/index.vue'
import DropdownPanel from '#kit/components/fragments/dropdown/panel/index.vue'
import DropdownOptionRow from '#kit/components/fragments/dropdown/option/index.vue'
import DropdownSelectedChips from '#kit/components/fragments/dropdown/selected-chips/index.vue'
...
<style lang="scss">
@use '#kit/assets/stylesheet/components/dropdown' as *;
