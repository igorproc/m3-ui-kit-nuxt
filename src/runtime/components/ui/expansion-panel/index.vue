...
import { useExpansionPanelGroupContext } from '#kit/composables/expansion-panel/useExpansionPanelGroup'
...
<style lang="scss">
@use '#kit/assets/stylesheet/components/expansion-panel/index' as *;
