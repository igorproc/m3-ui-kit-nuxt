...
import { useHotkey } from '~/composables/hotkey/useHotkey'
import { __resetHotkeyRegistry, popScope, pushScope } from '~/composables/hotkey/registry'
import { buildAriaLabel, buildDisplayKeys } from '~/composables/hotkey/format'
