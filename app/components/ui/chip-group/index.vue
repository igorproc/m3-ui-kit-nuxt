...
import { provideChipGroupContext } from '~/composables/chip-group/context'
import type {
  MChipGroupContext,
  MChipGroupTicket,
  MChipRegistration,
} from '~/composables/chip-group/context'
...
<style lang="scss">
@use '~/assets/stylesheet/components/chip-group/index' as t;
