  ...
  <section class="ui-test-section">
    <header class="ui-test-section__header">
      ...
      <p class="ui-test-section__description">
        Search field following Material 3 search patterns with leading icon, clear action and focus state.
      </p>
    </header>
    ...
    <div class="ui-test-grid">
      <div class="ui-test-grid__column">
        ...
        <div class="ui-test-grid__debug">
          <span>model: "{{ searchValue }}"</span>
        </div>
      </div>
    </div>
  </section>
