...
import MTable from '../app/components/ui/table/index.vue'
import MTableHeader from '../app/components/ui/table/header/index.vue'
import MTablePagination from '../app/components/ui/table/pagination/index.vue'
