...
import { useHotkey } from '../app/composables/hotkey/useHotkey'
import { __resetHotkeyRegistry, popScope, pushScope } from '../app/composables/hotkey/registry'
import { buildAriaLabel, buildDisplayKeys } from '../app/composables/hotkey/format'
import MHotkey from '../app/components/ui/hotkey/index.vue'
import type { HotkeyKey } from '../shared/types/hotkey'
